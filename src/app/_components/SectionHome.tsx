import AnimatedBayMax from "@/components/AnimatedBayMax";
...
const SectionHome = () => {
  return (
    <div
      id="home"
      className="relative xl:max-h-screen p-10"
    >
      ...
      <MaxWidthWrapper className="py-24  flex max-xl:flex-wrap justify-center items-center gap-14">
        ...
        <div className="xl:w-1/2 min-w-96 flex flex-col gap-5">
          ...
          <h1 className="text-4xl leading-tight">
            a Full-Stack Developer who is very passionate
            about Artificial Intelligence
          </h1>
          <p className="text-xl opacity-70 leading-10">
            My mission is to design and develop Webs/ Apps
            that are both functional and visual appealing,
